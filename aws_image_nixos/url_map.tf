...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-east-1.hvm-ebs" = "ami-0c42f97e5b1fda92f"
    "latest.ap-northeast-1.hvm-ebs" = "ami-0c3311601cbe8f927"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0020146701f4d56cf"
    "latest.ap-south-1.hvm-ebs" = "ami-0117e2bd876bb40d1"
    "latest.ap-southeast-1.hvm-ebs" = "ami-08f648d5db009e67d"
    "latest.ap-southeast-2.hvm-ebs" = "ami-0be390efaccbd40f9"
    "latest.ca-central-1.hvm-ebs" = "ami-020c24c6c607e7ac7"
    "latest.eu-central-1.hvm-ebs" = "ami-0eed77c38432886d2"
    "latest.eu-north-1.hvm-ebs" = "ami-0be5bcadd632bea14"
    "latest.eu-west-1.hvm-ebs" = "ami-0057cb7d614329fa2"
    "latest.eu-west-2.hvm-ebs" = "ami-0d46f16e0bb0ec8fd"
    "latest.eu-west-3.hvm-ebs" = "ami-0e8985c3ea42f87fe"
    "latest.sa-east-1.hvm-ebs" = "ami-021637976b094959d"
    "latest.us-east-1.hvm-ebs" = "ami-0a2cce52b42daccc8"
    "latest.us-east-2.hvm-ebs" = "ami-09378bf487b07a4d8"
    "latest.us-west-1.hvm-ebs" = "ami-09b4337b2a9e77485"
    "latest.us-west-2.hvm-ebs" = "ami-081d3bb5fbee0a1ac"
  }
